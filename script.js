...
// Show an initial array of topics
var topics = ['orchid', 'sunflower', 'peony'];
...
function renderButtons();
{
    ...
    for (var i = 0; i < topics.length; i++)
    {
      ...
      $('#buttonView').append(a); // Added the button to the HTML
    }
  }
...
// ========================================================
  ...
  function displaytopicGif()
  {
    ...
    var queryURL = "http://api.giphy.com/v1/gifs/search?q=" + topic + "&api_key=TPk9x4ggMzZI73bIvUtmuQSGFRhmdIo3&limit=10&offset=0";
